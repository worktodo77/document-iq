...
IDENTITY_NOTE = (
    ...
    "engine version; whether the run skipped reading the images on pages that "
    "also carry a text layer (skip_images_on_text_pages, contract amendment "
    "A-25; a run with OCR off reads none and records the skip); the confirmed "
    "Bates pattern; and RunConfig.limits — the "

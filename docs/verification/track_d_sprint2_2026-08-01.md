...
>
> **Only the swap references in this note are affected.** Track D's own subject
> matter is unchanged; any sentence here describing `commit_staging`,
> `mark_ready`, the readiness marker or set-aside trees describes deleted code.
